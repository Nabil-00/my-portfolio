...
| content-visibility + font preload | CSS 32.22KB / HTML 74KB ≈ baseline (noise); sections skip offscreen render, font preconnected+preloaded | keep | rendering-time gain, zero risk, no visual change |
